...
For detailed data model information, see:
- `specs/001-i-want-to/data-model.md` - Complete inventory data model specification
- `specs/004-databricks-inventory-analytics/DATA_MODEL_ALIGNMENT.md` - Data model alignment analysis
